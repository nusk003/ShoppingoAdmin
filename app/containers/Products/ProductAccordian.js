...
class AdvancedAccordion extends React.Component {
      ...
      <div className={classes.root}>
        <ExpansionPanel>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            ...
            <div className={classes.column}>
              <Typography className={classes.secondaryHeading}>{product.category.title}</Typography>
            </div>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails className={classes.details}>
              <ProductWizard {...{brands,categories,product}} />
